    ...
    <div className="bg-[#08080f] overflow-hidden relative rounded-[36px] size-full">
      ...
      >
        ...
        <motion.path
          ...
          style={{ filter: 'drop-shadow(0 0 4px rgba(212, 175, 120, 0.8))' }}
        />
        <motion.path
          d={svgPaths.pc875900}
          fill="#D4AF78"
